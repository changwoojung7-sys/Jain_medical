        ...
        <section className="about-greeting">
          ...
          <div className="card greeting-card">
            <div className="greeting-content">
              ...
              <p>
                우리는 화려한 수식어보다 절삭력의 일관성, 정확한 납기 준수, 그리고 현장의 문제를 즉각 해결할 수 있는 책임감을 최우선으로 합니다.
                단 한 순간의 검사 공백도 허용되지 않는 병리과 현장에서, 필요할 때 즉시 연결되는 가장 신뢰할 수 있는 파트너가 되겠습니다.
              </p>
              <p>
                규모는 작을지라도 제품의 기본 품질을 철저히 지키는 고집으로,
                고객사의 진단 신뢰도를 높이는 든든한 동반자가 될 것을 약속드립니다.
              </p>
