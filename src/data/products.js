...
import pathoCutterR35Thumb from "../assets/products/pathology/patho_cutter_r_35_thumb.png";
import pathoCutterR35Detail from "../assets/products/pathology/patho_cutter_r_35_detail.png";
import pathoCutterHpR35 from "../assets/products/pathology/patho_cutter_hp_r_35.png";

const sharedDetailDescription = "뛰어난 예리함을 실현하여 조직학적 절편, 장기 슬라이스, 세포 시료 등의 연조직 시료의 클린으로 조직 손상을 최소화한 정확한 절편화를 실현합니다. 이 블레이드는 장기간 사용해도 선명도와 내구성을 유지하면서 특성이 지속되고 신뢰성이 높은 결과를 얻을 수 있으므로 정확한 현미경 검사가 가능합니다.";
...
export const products = [
  ...
  },
  {
    ...
    category: "임상병리실 소모품",
    name: "파소 커터 R (35°)",
    image: pathoCutterR35Thumb,
    detailImage: pathoCutterR35Detail,
